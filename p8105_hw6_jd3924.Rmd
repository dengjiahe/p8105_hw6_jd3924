...
male_vs_female
```
Holding all other variables constant, homicides with male victims are relatively less likely to be resolved than homicides with female victims in all cities.
